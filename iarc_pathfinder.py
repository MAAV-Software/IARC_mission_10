...
def generate_minefield(num_mines=135, seed=0.1934):
    """Generate random mine positions on the grid (local RNG, won't match fexl.com)."""
    ...
    return set(all_cells[i] for i in indices)
...
def main():
    ...
    parser.add_argument('--fexl', action='store_true',
    ...
    if args.batch:
        ...
        for i in range(args.batch):
            ...
            mines = generate_minefield(args.mines, seed)
    ...
    if args.fexl:
        ...
        mines = generate_minefield(args.mines, args.seed)
